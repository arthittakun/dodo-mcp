...
const GATEWAY_SPECS: readonly GatewaySpec[] = [
  ...
  },
  {
    ...
    domain: 'code',
    summary: 'preview-only refactors, explicit verification and owner-controlled Project Brain maintenance',
    operations: ['preview_refactor', 'verify_changes', 'brain_rebuild', 'brain_pause', 'brain_cancel'],
  },
  {
    name: 'dodo_media',
