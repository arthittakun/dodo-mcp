...
export async function startLocalConfig(target: Target, port = 21731, info: LocalConfigInfo = {}): Promise<LocalConfigServer> {
  ...
  for (const critical of ['workbench.js', 'workbench.css', 'ui/dom.js', 'ui/recovery.js', 'ui/deployment.js', 'ui/tooltips.js', 'ui/alerts.js', 'vendor/sweetalert2.min.js', 'vendor/sweetalert2.min.css']) loadAsset(critical);
